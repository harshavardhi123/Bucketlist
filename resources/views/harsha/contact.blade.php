	...
	<section class="container tm-home-section-1" id="more">
		<div class="row">
			...
			<div class="flexslider effect2 effect2-contact tm-contact-box-1">
				<ul class="slides">
					<li>
						<img src="img/worldmap1.png" alt="image" class="contact-image" />
						<div class="contact-text">
							<h2 class="slider-title">Travel Around The Globe Without Any Hassel.</h2>
							<h3 class="slider-subtitle">We provide you hassel free travels and accommodation in budget friendly packages.</h3>
							<p class="slider-description">By choosing us you can feel a great services which we offer. Our packages are budget friendly and we will take care everything from flight bookings, accommodation, guide, rental cars, foods. You need to just select a package which you want and we can negotiate with extra things which you want in your vacation.</p>
